...
def get_dataset(args):
    if args.dataset == 'TUAB':
        ...
        ch_names = None
        metrics = ["accuracy", "balanced_accuracy"] # "roc_auc" , "pr_auc", cant be used as all labels are either one or zero.
        ...
        for train_index, test_index in loo.split(all_data):
            ...
            for epoch in range(args.epochs):
                train_stats = train_one_epoch(model, criterion, data_loader_train, optimizer,
                                            ...
                                            log_writer=None, start_steps=epoch * len(data_loader_train),
